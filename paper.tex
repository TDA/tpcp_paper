...
A similar VM-based approach is taken in~\cite{oliveria2008b}. The Bezoar framework proposed in this paper tries to recover a system based on monitoring of propagation bytes in the system after hijacking attack has been detected. The framework replays the checkpointed run while ignoring inputs from malicious sources.
