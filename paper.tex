...
itself is is monitoring itself, rather than external analysis of
...
introduced by a benign developer. Therefore, Trojan behavior is more
...
Another approach has been to include run-time monitoring into the
...
Security of the application lays has received significant attention
from the research community. Because of this, we have divided the
research into attack surface reduction, prevent control-flow
...
control-flow integrity, essentially ensuring dynamically at run-time
